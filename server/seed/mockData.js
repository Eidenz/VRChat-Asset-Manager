// server/seed/mockData.js - Fixed version
...
// These need to match exactly with avatar bases referenced elsewhere
const avatarBases = [
...
// Make sure avatars use exactly the same base names as defined above
const avatars = [
  {
    id: 1,
    name: 'Neo Cat',
    base: 'Feline3.0', // This must exactly match an avatarBases name
...
// Ensure these reference the exact names in assetTypes and avatarBases
...
function getRecentAssets(count = 5) {
