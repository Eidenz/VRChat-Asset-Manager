...
import { clothingAssets, assetTags } from '../data/mockData';
...
const Clothing = () => {
  ...
  useEffect(() => {
    // Simulate API call
    setTimeout(() => {
      setAssets(clothingAssets);
      setFilteredAssets(clothingAssets);
      
      // Extract available filters
      const tags = [...new Set(clothingAssets.flatMap(asset => asset.tags))];
      const creators = [...new Set(clothingAssets.map(asset => asset.creator))];
